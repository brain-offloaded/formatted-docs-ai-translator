...
export const JsonFileTranslator = getTranslatorComponent(TranslationType.JsonFile);
export const JsonStringTranslator = getTranslatorComponent(TranslationType.JsonString);
